...
<div align="center">
  ...
  <br>
  <sub>Разработка, геймдизайн, звук, "сырная власть"</sub>
  <br><br>
  <a href="https://github.com/MindlessMuse666/tom-i-jerry" target="_blank">🔗 Репозиторий проекта</a>
</div>

<br>

> 📚 **Учебная практика** - проект создан в рамках практической работы в колледже, цель которой - освоить принципы разработки 2D‑игр, работу с физическим движком и создание интерактивного геймплея на Python.
